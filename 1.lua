...
InfoSection:AddLabel("Current Sea: " .. CurrentSea)

-- Auto Join Section
local AutoJoinSection = MainTab:AddSection({
    Name = "Full Moon Auto Join"
})
...
local DelaySection = SettingsTab:AddSection({
    Name = "Auto Join Settings"
})

DelaySection:AddSlider({
    Name = "Check Delay",
    Min = 1,
    Max = 30,
    Default = 5,
...
local StatusSection = StatusTab:AddSection({
    Name = "Live Status"
})

local MoonStatus = StatusSection:AddLabel("Checking moon status...")
local TimeStatus = StatusSection:AddLabel("Getting time...")
local AutoJoinStatus = StatusSection:AddLabel("Auto Join: OFF")
...
local ServerSection = ServersTab:AddSection({
    Name = "Available Servers"
})

local ServerList = ServerSection:AddLabel("No servers found")
